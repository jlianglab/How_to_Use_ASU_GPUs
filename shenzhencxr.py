...
import argparse
import os
from config import ShenzhenRCXR as config
from datasets import ShenzhenCXR,build_transform
...
def main(conf):
    ...
    train_dataset = ShenzhenCXR(conf.data_root, conf.train_list, build_transform())
    valid_dataset = ShenzhenCXR(conf.data_root, conf.valid_list, build_transform(mode="validation"))
    test_dataset = ShenzhenCXR(conf.data_root, conf.test_list, build_transform(mode="test"))
